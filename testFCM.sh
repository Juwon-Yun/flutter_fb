...
curl -X POST --header "Authorization: key=$api_key" --header "Content-Type: application/json" https://fcm.googleapis.com/fcm/send -d '{
      "to" : "fUofM_74z0KznC05zsamqv:APA91bEiuPn7YmMkRlGFMKDkQ30G4n3Z0caZnTtj3cJLeo2QrDjxRRpPsYwv4vZHY0rj6RgHIq_d4ce1f6QYapxHpKu_nEAuD-sPjN7Z2AsZOELWmcYMp5cfOkTbtiYszT7gpy5LmWUP",
      "priority" : "high",
      "notification" : {
